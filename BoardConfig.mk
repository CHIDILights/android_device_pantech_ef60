...
BOARD_MKBOOTIMG_ARGS  	 := --kernel_offset 0x0008000 --ramdisk_offset 0x2000000  --tags_offset 0x0000100 --dt device/pantech/ef60/prebuilt/dt.img
TARGET_PREBUILT_KERNEL   := device/pantech/ef60/prebuilt/kernel
